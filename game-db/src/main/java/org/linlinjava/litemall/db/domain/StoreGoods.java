...
public class StoreGoods implements Cloneable, Serializable {
    ...
    public String toString() {
        ...
        sb.append(", showPos=").append(showPos);
        sb.append(", rpos=").append(rpos);
        sb.append(", saleQuota=").append(saleQuota);
        sb.append(", recommend=").append(recommend);
        sb.append(", coin=").append(coin);
        sb.append(", discount=").append(discount);
        sb.append(", type=").append(type);
        sb.append(", quotaLimit=").append(quotaLimit);
        sb.append(", mustVip=").append(mustVip);
        sb.append(", isGift=").append(isGift);
        sb.append(", followPetType=").append(followPetType);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getForSale() == null ? other.getForSale() == null : this.getForSale().equals(other.getForSale()))
            && (this.getShowPos() == null ? other.getShowPos() == null : this.getShowPos().equals(other.getShowPos()))
            && (this.getRpos() == null ? other.getRpos() == null : this.getRpos().equals(other.getRpos()))
            && (this.getSaleQuota() == null ? other.getSaleQuota() == null : this.getSaleQuota().equals(other.getSaleQuota()))
            ...
            && (this.getQuotaLimit() == null ? other.getQuotaLimit() == null : this.getQuotaLimit().equals(other.getQuotaLimit()))
            && (this.getMustVip() == null ? other.getMustVip() == null : this.getMustVip().equals(other.getMustVip()))
            && (this.getIsGift() == null ? other.getIsGift() == null : this.getIsGift().equals(other.getIsGift()))
            && (this.getFollowPetType() == null ? other.getFollowPetType() == null : this.getFollowPetType().equals(other.getFollowPetType()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getForSale() == null) ? 0 : getForSale().hashCode());
        result = prime * result + ((getShowPos() == null) ? 0 : getShowPos().hashCode());
        result = prime * result + ((getRpos() == null) ? 0 : getRpos().hashCode());
        result = prime * result + ((getSaleQuota() == null) ? 0 : getSaleQuota().hashCode());
        ...
        result = prime * result + ((getQuotaLimit() == null) ? 0 : getQuotaLimit().hashCode());
        result = prime * result + ((getMustVip() == null) ? 0 : getMustVip().hashCode());
        result = prime * result + ((getIsGift() == null) ? 0 : getIsGift().hashCode());
        result = prime * result + ((getFollowPetType() == null) ? 0 : getFollowPetType().hashCode());
     ...
     * This enum corresponds to the database table store_goods
     *
     * @mbg.generated
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
