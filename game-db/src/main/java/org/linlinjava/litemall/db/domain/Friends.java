...
public class Friends implements Cloneable, Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getHy1() == null ? other.getHy1() == null : this.getHy1().equals(other.getHy1()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getHy1() == null) ? 0 : getHy1().hashCode());
     ...
     * This enum corresponds to the database table friends
     *
     * @mbg.generated
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
