...
public class Reports implements Cloneable, Serializable {
    ...
    public String toString() {
        ...
        sb.append(", yuanbaoshu=").append(yuanbaoshu);
        sb.append(", shifouchongzhi=").append(shifouchongzhi);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getYuanbaoshu() == null ? other.getYuanbaoshu() == null : this.getYuanbaoshu().equals(other.getYuanbaoshu()))
            && (this.getShifouchongzhi() == null ? other.getShifouchongzhi() == null : this.getShifouchongzhi().equals(other.getShifouchongzhi()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getYuanbaoshu() == null) ? 0 : getYuanbaoshu().hashCode());
        result = prime * result + ((getShifouchongzhi() == null) ? 0 : getShifouchongzhi().hashCode());
     ...
     * This enum corresponds to the database table reports
     *
     * @mbg.generated
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
